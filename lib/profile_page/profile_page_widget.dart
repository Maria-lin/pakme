...
class _ProfilePageWidgetState extends State<ProfilePageWidget> {
  ...
  late DocumentReference userProfileReference;
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord?>(
      stream: UsersRecord.getDocument(currentUserReference as DocumentReference<Object?>),
                      ...
                      child: InkWell(
                        onTap: () async {
                          await Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => EditProfileWidget(userProfile:userProfileReference),
                            ),
                          );
                        },
                        child: Material(
