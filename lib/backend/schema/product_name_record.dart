...
abstract class ProductNameRecord
  ...
  @nullable
  DocumentReference<Object?> get productUser;  // Mettez à jour ici

  @nullable
  DocumentReference<Object?> get productPayment;  // Mettez à jour ici
...
Map<String, dynamic> createProductNameRecordData({
  ...
  DocumentReference<Object>?  productUser,
  DocumentReference<Object>? productPayment,
}) =>
